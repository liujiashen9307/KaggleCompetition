...
total = 0
changes = 0
out = open(os.path.join(SUBM_PATH, 'regex_filling.csv'), "w", encoding='UTF8')
out.write('"id","after"\n')
test = open(os.path.join(INPUT_PATH, "test2_with_class.csv"), encoding='latin1')
...
ddt = pickle.load(open('dict.pkl','rb'))
len(ddt)
