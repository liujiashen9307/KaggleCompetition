# -*- coding: utf-8 -*-
"""
Created on Fri Aug  4 22:31:17 2017
...
model = lgb.train(lgb_params, dtrain, 105)
print('Start predicting')
pred = model.predict(test[col],num_iteration=105)
print('Prediction Done')
test['reordered'] = pred
sub = sub_file(test,0.20,sample_submission)
test_set2 = test[['user_id','product_id','order_id','reordered']]
test_set2.to_csv('save_test_for_exp_azure_103_Feats_0.1.csv',index=False)
sub.to_csv('20170805_Azure_101Feats_0.1_220Leaves_1200rounds_lgb.csv',index=False)
##0.01 1200 same script
FI = get_feature_importance_lgb(model)
FI.to_csv('Feature_Importance_103Features_lr0.1.csv',index=False)
