...
model = lgb.train(lgb_params, dtrain, 1200)
print('Start predicting')
pred = model.predict(test[col],num_iteration=1200)
print('Prediction Done')
test['reordered'] = pred
sub = sub_file(test,0.20,sample_submission)
test_set2 = test[['user_id','product_id','order_id','reordered']]
test_set2.to_csv('save_test_for_exp_azure_86Feats.csv',index=False)
sub.to_csv('20170803_Azure_86Feats_0.01_1000Leaves_lgb.csv',index=False)
