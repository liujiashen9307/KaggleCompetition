# -*- coding: utf-8 -*-
"""
Created on Tue Aug  1 17:05:41 2017
...
sub.to_csv('submission/20170801_sub_86_features_80%_data_depth6_lgb_1500Rounds_0.20thres.csv',index=False)
...
test_set.to_csv('save_test_for_exp_5.csv',index=False)
