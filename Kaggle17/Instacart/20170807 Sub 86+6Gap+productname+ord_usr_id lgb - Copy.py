...
print(time.ctime())
model = lgb.train(lgb_params, dtrain, 450)
print('Start predicting')
print(time.ctime())
pred = model.predict(test[col],num_iteration=450)
print('Prediction Done')
print(time.ctime())
test['reordered'] = pred
sub = sub_file(test,0.20,sample_submission)
sub.to_csv('20170807_Azure_86feats_plus_gap_plus_name_and_ord_usr_id_450_Rounds.csv',index=False)
print('sub file generated')
test_set2 = test[['user_id','product_id','order_id','reordered']]
test_set2.to_csv('save_test_for_exp_azure20170807_Azure_86feats_plus_gap_plus_name_and_ord_usr_id_450_Rounds.csv',index=False)
