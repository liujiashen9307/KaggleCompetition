# -*- coding: utf-8 -*-
"""
Created on Sun Jul 30 14:19:09 2017

@author: Jiashen Liu

@Purpose: Create Features on department and aisle, and discard several features
...
"""
cols = ['_is_favoriate_dept','_is_freq_reorder_dept','_is_favoriate_ais','_is_freq_reorder_ais']
for each in cols:
    training[each] = training[each].fillna(0)
    testing[each] = testing[each].fillna(0)
"""
...
xgb_cv = xgb.cv(xgb_params, dtrain, num_boost_round=150, early_stopping_rounds=10,
    verbose_eval=5, show_stdv=False)

watchlist= [(dtrain, "train")]
model = xgb.train(xgb_params,dtrain,num_boost_round=300,early_stopping_rounds=10,evals=watchlist, verbose_eval=10)

FI =get_feature_importance(model)
FI.to_csv('FI_63_Features.csv',index=False)


pred = model.predict(dtest)
FScore = Cross_Validation(testing,pred,0.20)

## depth = 6: 0.37782217099586074, eta 0.2: 0.37568106821350439, eta 0.15 0.37698048046236654 eta 0.15, depth 5: 0.37748018881978884 depth 6 0.12 eta 90: 0.37759695749894484 
...
"""
Feature	Score
_up_order_since_last_order	367
_user_reorder_ratio	311
time_since_last_order	294
_prod_reorder_prob	275
_up_order_rate	230
_up_order_rate_since_first_order	186
_prod_reorder_ratio	172
_user_average_basket	170
_user_std_days_since_prior_order	129
_user_mean_days_since_prior_order	126
_user_sum_days_since_prior_order	120
_up_last_order_number	114
_user_std_hod	110
_prod_mean_cart_order	109
_prod_mean_days_since_prior_order	108
_prod_buy_first_time_total_cnt	97
_user_dept_reorder_rate	97
_user_mean_hod	91
_user_total_products	88
_order_hod_std	86
_user_ais_reorder_rate	84
_user_mean_dow	83
_usr_prd_buy_rate	83
_up_cart_position_std	82
_user_std_dow	81
_up_order_count	78
_prod_std_days_since_prior_order	77
_prod_std_cart_order	74
order_streak	74
W2V_1	71
_user_distinct_products	70
_prod_std_hod	69
_prod_mean_dow	68
_user_dept_total_orders	65
_prod_reorder_tot_cnts	64
_prod_std_dow	64
_prod_mean_hod	64
_up_average_cart_position	60
_prod_tot_cnts	59
_user_dept_total_reorders	57
W2V_2	54
_prod_sum_days_since_prior_order	54
_order_hod_mean	52
_user_ais_total_orders	48
_user_ais_total_reorders	48
_prod_buy_second_time_total_cnt	47
_up_first_order_number	44
_up_cart_position_median	44
_user_prd_order_std_day	43
_user_median_days_since_prior_order	43
_user_prd_order_mean_day	40
_user_total_orders	35
_user_median_hod	27
_order_hod_median	23
_user_median_dow	22
_prod_median_days_since_prior_order	14
_prod_reorder_times	9
_user_prd_order_median_day	9
_prod_median_cart_order	5
_is_favoriate_ais	4
_is_freq_reorder_dept	4
_total_time_of_reorder	3
_prod_median_dow	3
_is_favoriate_dept	2
_prod_median_hod	2


[0]     train-logloss:0.625649  test-logloss:0.625723
[5]     train-logloss:0.425766  test-logloss:0.42618
[10]    train-logloss:0.335312  test-logloss:0.336007
[15]    train-logloss:0.290694  test-logloss:0.291656
[20]    train-logloss:0.268111  test-logloss:0.269362
[25]    train-logloss:0.256526  test-logloss:0.258086
[30]    train-logloss:0.250506  test-logloss:0.25241
[35]    train-logloss:0.247194  test-logloss:0.249456
[40]    train-logloss:0.245218  test-logloss:0.247873
[45]    train-logloss:0.24395   test-logloss:0.247002
[50]    train-logloss:0.243084  test-logloss:0.246535
[55]    train-logloss:0.242362  test-logloss:0.246182
[60]    train-logloss:0.241748  test-logloss:0.245916
[65]    train-logloss:0.241192  test-logloss:0.245724
[70]    train-logloss:0.240695  test-logloss:0.245575
[75]    train-logloss:0.24021   test-logloss:0.245432
[80]    train-logloss:0.239771  test-logloss:0.245349
[85]    train-logloss:0.239354  test-logloss:0.245258
"""