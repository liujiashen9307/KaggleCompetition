# -*- coding: utf-8 -*-
"""
Created on Sat Jul 29 23:27:43 2017

@author: Jiashen Liu

Purpose: Train on full dataset with new features
"""
...
model = xgb.train(xgb_params,dtrain,num_boost_round=300,verbose_eval=10, evals=watchlist,early_stopping_rounds=20)
del dtrain
pred = model.predict(dtest)
del dtest
test_set['reordered'] = pred
sub = sub_file(test_set,0.20,sample_submission)
sub.to_csv('submission/20170730_sub_57_features_full_data_depth6_eta0.1_300rounds_0.20thres.csv',index=False)
...
test_set.to_csv('save_test_for_exp_2.csv',index=False)
