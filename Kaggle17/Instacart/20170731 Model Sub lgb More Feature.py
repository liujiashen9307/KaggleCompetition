# -*- coding: utf-8 -*-
"""
Created on Mon Jul 31 20:03:26 2017
...
sub.to_csv('submission/20170731_sub_74_features_full_data_depth6_lgb_1000Rounds_0.20thres.csv',index=False)
#sub.to_csv('submission/20170731_sub_74_features_full_data_depth6_lgb_600Rounds_0.20thres.csv',index=False)
...
test_set.to_csv('save_test_for_exp_6.csv',index=False)
