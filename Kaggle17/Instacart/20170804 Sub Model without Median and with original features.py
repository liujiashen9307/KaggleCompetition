...
pred = model.predict(test[col],num_iteration=2000)
print('Prediction Done')
print(time.ctime())
test['reordered'] = pred
sub = sub_file(test,0.20,sample_submission)
test_set2 = test[['user_id','product_id','order_id','reordered']]
test_set2.to_csv('save_test_for_exp_without_median_76_Feats.csv',index=False)
sub.to_csv('submission/20170804_without_median_with_original_2000Rounds_lgb.csv',index=False)
