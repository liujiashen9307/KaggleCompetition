...
sub.to_csv('submission/20170731_sub_63_features_full_data_depth6_lgb_400Rounds_0.20thres.csv',index=False)
...
test_set.to_csv('save_test_for_exp_4.csv',index=False)
