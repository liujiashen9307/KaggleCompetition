...
ROUNDS = 1600
model = lgb.train(lgb_params, dtrain, ROUNDS,verbose_eval=40)
print('Training Done')
...
test_set2.to_csv('save_test_for_exp_9.csv',index=False)
sub.to_csv('submission/20170803_lgb_74FeatandIDs_240leaves_0.01LR.csv',index=False)
